...
- `sound.js` owns room audio glue, the room preset for the shared space lo-fi song, mapping from star-touch pulse and resonance state to song reaction events, and the browser-only Web Audio performer.
